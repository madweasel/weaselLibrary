...
void DX::DeviceResources::CreateDeviceResources() 
{
    ...
    {
        throw std::logic_error("CreateEvent");
    }
}
...
void DX::DeviceResources::GetAdapter(IDXGIAdapter1** ppAdapter)
{
    *ppAdapter = nullptr;
    ...
    if (!adapter)
    {
        ...
        {
            throw std::logic_error("WARP12 not available. Enable the 'Graphics Tools' feature-on-demand");
        }
    ...
    if (!adapter)
    {
        throw std::logic_error("No Direct3D 12 device found");
    }
