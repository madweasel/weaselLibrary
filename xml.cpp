...
// Desc: class constructor
//-----------------------------------------------------------------------------
xmlClass::xmlClass(string &sourceFile, xmlNode* &theRootNode) : xmlClass()
{
...
// Desc: 
//-----------------------------------------------------------------------------
bool xmlClass::writeFile(string &destFile)
{
	// locals
	IStream  *		pFileStream;
	bool			returnValue;
	...
	// open file
	SHCreateStreamOnFileA(destFile.c_str(), STGM_WRITE | STGM_CREATE, &pFileStream);
	if (pFileStream==NULL) { 
...
// Desc: 
//-----------------------------------------------------------------------------
bool xmlClass::loadFile(string &sourceFile)
{
	// locals
	IStream  *		pFileStream;
	bool			returnValue;
	...
	// open file
	SHCreateStreamOnFileA(sourceFile.c_str(), STGM_READ, &pFileStream);
	if (pFileStream==NULL) { 
