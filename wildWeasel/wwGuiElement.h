...
namespace wildWeasel
{
	...
	public:
		...
		bool								create								(masterMind* ww, wstring &theText, font2D* theFont, float depthInSpace = 0);
	...
	{
	public:
		bool								create								(masterMind* ww, wstring &theText, font3D* theFont);
	...
	protected:
		...
		void								focusThis							();
		void								addOrRemoveEventFuncFromVector		(eventFunction& eventFunc, vector<eventFunction>& eventFuncVector);
	...
	public:									
		...
		void								insertTextItem						(unsigned int itemIndex, wstring& text, buttonImageFiles& buttonFiles);
		void								insertItem							(unsigned int itemIndex, wstring& text, buttonImageFiles& buttonFiles, guiElemCluster2D* newSubItem = nullptr);
	...
	private:
		struct axis
		{
			...
			void							create								(masterMind* ww, font3D* theFont, wstring &theText, color initColor);
		};
