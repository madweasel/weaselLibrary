...
// Desc: 
//-----------------------------------------------------------------------------
void wildWeasel::rotationControlCube::createButton(plainButton& myButton, vector3& position, vector3& rotation, vector3& scale, texture& tex, function<void(guiElemEvFol*, void*)> userFunc)
{
...
// Desc: 
//-----------------------------------------------------------------------------
bool wildWeasel::rotationControlCube::compareMatrices(matrix& a, matrix& b)
{
...
// Desc: 
//-----------------------------------------------------------------------------
wildWeasel::rotationControlCube::faceAreaRollIndex wildWeasel::rotationControlCube::findStateMatrix(matrix& toMatrix)
{
