...
#include "weaselEssentials/src/xml.h"
#include "wwThread.h"
...
namespace wildWeasel
{
	...
	public:									
		...
		virtual bool						deactivate							()	{ return true; };					// when false is returned, then the scenario switch is aborted
