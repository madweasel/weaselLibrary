...
namespace wildWeasel
{
	...
	// information about a font for displaying 2D texts
	// TODO: currently only a dummy 2D text is used. real 3d text must be implemented
	...
	public:
		...
		void								setPosition							(vector3 const & newPosition, bool relativeToView, bool updateMatrix);
		void								setScale							(vector3 const & newScale   , bool relativeToView, bool updateMatrix);
		void								setRotation							(vector3 const & newRotation, bool relativeToView, bool updateMatrix);
