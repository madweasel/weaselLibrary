...
// Desc: 
//-----------------------------------------------------------------------------
void wildWeasel::guiElemEvFol::addOrRemoveEventFuncFromVector(eventFunction const& eventFunc, vector<eventFunction>& eventFuncVector)
{
...
// Desc: 
//-----------------------------------------------------------------------------
bool wildWeasel::textLabel3D::create(masterMind* ww, wstring const &theText, font3D* theFont)
{
	// params ok?
	if (!ww)			return false;
	if (initialized)	return false;
...
// Desc: 
//-----------------------------------------------------------------------------
void wildWeasel::triad::axis::create(masterMind* ww, font3D* theFont, wstring const &theText, color initColor)
{
	axisColor			= initColor;
...
// Desc: 
//-----------------------------------------------------------------------------
bool wildWeasel::textLabel2D::create(masterMind* ww, wstring const &theText, font2D* theFont, float depthInSpace)
{
	// params ok?
	if (!ww)			return false;
	if (initialized)	return false;
...
// Desc: scrollTo
//-----------------------------------------------------------------------------
void wildWeasel::scrollBarDuo::scrollTo(scrollPosition pos)
{
	switch (pos)
	{
	...
	case scrollPosition::RIGHT:
		if (columnScrollBar) columnScrollBar->setSledgePos(1);
		break;
	}		
}
...
// Desc: 
//-----------------------------------------------------------------------------
void wildWeasel::dropDown2D::insertTextItem(unsigned int itemIndex, wstring const& text, buttonImageFiles& buttonFiles)
{
	// locals
...
// Desc: 
//-----------------------------------------------------------------------------
void wildWeasel::dropDown2D::insertItem(unsigned int itemIndex, wstring const& text, buttonImageFiles& buttonFiles, guiElemCluster2D* newSubItem)
{
	// params ok?
