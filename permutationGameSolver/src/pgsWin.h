...
#pragma region zones and sequences
	...
	public:
		...
		void													create									(pgsThread* pgsT, pgsWin* pgsW, wildWeasel::masterMind *ww, wildWeasel::listView2D* pList, float listViewTextSize, unsigned int listRowHeight, wildWeasel::buttonImageFiles& buttonImages, wildWeasel::font2D* font);
